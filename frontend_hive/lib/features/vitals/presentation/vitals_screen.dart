      ...
      SliverPadding(
        ...
        sliver: SliverList(
          delegate: SliverChildListDelegate([
            ...
            const Text(
              'Trends from your connected health devices',
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    height: 76,
                    child: CustomPaint(
                      painter: _TrendPainter(color: AppColors.danger),
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const Text(
          'mmHg · Last updated today at 8:42 AM',
